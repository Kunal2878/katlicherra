                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="relative">
                    <input
                      ...
                      required
                    />
                    <label className="absolute left-0 -top-3.5 text-black-200 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-black-200 peer-focus:text-sm">
                      Exam Name
                    </label>
                  </div>
                  <div className="relative">
                    <input
                      ...
                      required
                    />
                    <label className="absolute left-0 -top-3.5 text-black-200 text-sm">
                      Exam Date
                    </label>
                  </div>
                  <div className="relative">
