        ...
        <div className="mb-8">
          ...
          >
            ...
            >
              ...
              <div
                className="w-full absolute text-lg flex flex-row text-white"
                style={{ top: "13%", left: "5%" }}
              >
              ...
              {/* Footer Elements */}
              <div className="absolute w-full bottom-16 right-0 flex flex-row justify-end">
                <span className="right-0 mr-8 font-black">
                  {" "}
                  Sign. of Principal
                </span>
              </div>
